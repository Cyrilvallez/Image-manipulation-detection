...
hash_ref = nh.inception_hash(img_ref, hash_size=HASH_SIZE)
hash_adv = nh.inception_hash(img_adv, hash_size=HASH_SIZE)
...
for file in os.listdir('data'):
    if file.startswith('lena') and file != 'lena.png':
        ...
        hash_ = nh.inception_hash(img, hash_size=HASH_SIZE)
        names.append(file)
        hashes.append(hash_)
